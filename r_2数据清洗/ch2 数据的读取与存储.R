...
# json读取文件1----只能读取1条数据
library(rjson)
data1 = fromJSON(file = "2019-3-24 博越口碑.json",
...
# json读取文件2 -----读取了所有的数据4546
library(jsonlite)
jsonlite::stream_in(file("2019-3-24 博越口碑.json"),pagesize = 10)
data2=jsonlite::stream_in(file("2019-3-24 博越口碑.json"),pagesize = 50)
class(data2)
length(data2$title)
head(data2, n=2)
names(data2)
